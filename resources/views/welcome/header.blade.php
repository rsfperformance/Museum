<header class="header">
    <div class="header-head">
        <div class="container">
            <ul class="header-head__menu">
                <li class="header-style__show">
                    <a href="#">
                ...
                <li>
                    <a href="#" class="sound-off">
                        ...
                        <span>
                            {{ __('asd.Выключить звук') }}
                        </span>
                    </a>
                    <a href="#" class="sound-on">
                        <svg width="13" height="19" viewBox="0 0 13 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M11.2836 0.1607C10.6906 -0.117101 10.0096 -0.0292263 9.50644 0.390073L4.80786 4.30553H1.66981C0.749054 4.30553 0 5.05458 0 5.97534V13.0254C0 13.9461 0.749054 14.6952 1.66981 14.6952H4.8079L9.50648 18.6107C10.0101 19.0304 10.6912 19.1176 11.2837 18.8401C11.8768 18.5623 12.2452 17.9828 12.2452 17.3279V1.67284C12.2452 1.01789 11.8768 0.438501 11.2836 0.1607ZM4.4528 13.5894H1.66981C1.36292 13.5894 1.11321 13.3323 1.11321 13.0254V5.97534C1.11321 5.66845 1.36292 5.41874 1.66981 5.41874H4.4528V13.5894ZM11.132 17.3279C11.132 17.6562 10.8867 17.7967 10.8115 17.8319C10.7363 17.8671 10.4714 17.9657 10.2191 17.7554L5.56601 13.8779V5.12283L10.2191 1.24526C10.4714 1.035 10.7364 1.13356 10.8115 1.16878C10.8867 1.20399 11.132 1.34442 11.132 1.67284V17.3279Z" fill="white"/>
                        </svg>					
                        <span>
                            {{ __('asd.Включить звук') }}
                        </span>
                    </a>
                </li>
            </ul>
            <div class="header-head__follow">
                <ul class="follow">
                ...
                <div class="header-head__text">
                    {{ __('asd.Подписывайтесь на нас') }}
                </div>
                <div class="header-head__lang">
                    @foreach(\App\Lang::all() as $data)
                        <a href="/languages/{{ $lan }}" alt="ico">
                            @if($data->prefix == $lan)
                                <img src="{{ $data->photo }}" alt="ico">@if($data->id != 6 && $data->id != 7 && $data->id != 4 && $data->id != 5 && $data->id != 8) {{ $data->prefix }}@endif
    ...
    <div class="header-menu">
        <div class="container">
            ...
            <ul class="menu">
                <li class="menu__item">
                    <a class="menu__link">{!! __('asd.Законодательство <br> о семье') !!}</a>
                    <svg viewBox="0 0 8 4" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M7.46393 0L8 0.449045L4.00013 4L0 0.449045L0.536183 0L3.64202 2.75679L4.00013 3.07466L4.37554 2.74142L7.46393 0Z" fill="white"/>
                    </svg>
                    <ul class="submenu">
                ...
                <li class="menu__item">
                    <a class="menu__link">{!! __('asd.История узбекской <br> семьи') !!}</a>
                    <svg viewBox="0 0 8 4" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M7.46393 0L8 0.449045L4.00013 4L0 0.449045L0.536183 0L3.64202 2.75679L4.00013 3.07466L4.37554 2.74142L7.46393 0Z" fill="white"/>
                    </svg>
                    <ul class="submenu">
                ...
                <li class="menu__item">
                    <a class="menu__link">{!! __('asd.Типология <br> брака и семьи') !!}</a>
                    <svg viewBox="0 0 8 4" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M7.46393 0L8 0.449045L4.00013 4L0 0.449045L0.536183 0L3.64202 2.75679L4.00013 3.07466L4.37554 2.74142L7.46393 0Z" fill="white"/>
                    </svg>
                    <ul class="submenu">
                ...
                {{--<li class="menu__item">
                    <a href="/features/1" class="menu__link">{!! __('asd.Региональные особенности <br> узбекских семей') !!}</a>
                </li>--}}
                <li class="menu__item">
                    <a href="/familyall" class="menu__link">{!! __('asd.Ceмейный <br> церемониал') !!}</a>
                </li>
                <li class="menu__item">
                    <a href="/" class="menu__link">{{ __('asd.Полезные ресурсы') }}</a>
                    <svg viewBox="0 0 8 4" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M7.46393 0L8 0.449045L4.00013 4L0 0.449045L0.536183 0L3.64202 2.75679L4.00013 3.07466L4.37554 2.74142L7.46393 0Z" fill="white"/>
                    </svg>
                    <ul class="submenu">
                                <li class="subsubmenu__item">
                                    <a href="/usefulall/1" class="subsubmenu__link">
                                        {{ __('asd.Монографии') }}
                                    </a>
                                </li>
                                <li class="subsubmenu__item">
                                    <a href="/usefulall/3" class="subsubmenu__link">
                                        {{ __('asd.Научные статьи') }}
                                    </a>
                                </li>
                                <li class="subsubmenu__item">
                                    <a href="/usefulall/4" class="subsubmenu__link">
                                        {{ __('asd.Диссертации') }}
                                    </a>
                                </li>
                                <li class="subsubmenu__item">
                                    <a href="/usefulall/5" class="subsubmenu__link">
                                        {{ __('asd.Статьи в СМИ') }}
                                    </a>
                                </li>
                                <li class="submenu__item">
                                    <a href="/usefulall/6" class="submenu__link">
                                        {!! __('asd.Изречения, пословицы, поговорки, <br> стихи') !!}
                                    </a>
                                </li>
                                {{--<li class="submenu__item">--}}
                                    {{--<a href="/usefulall/7" class="submenu__link">--}}
                ...
                <li class="menu__item">
                    ...
                    <ul class="submenu">
                        <li class="submenu__item">
                            <a href="/photos" class="submenu__link">
                                 	{{ __('asd.Фото галерея') }}		
                            </a>
                        </li>
                        <li class="submenu__item">
                            <a href="/videos" class="submenu__link">
                                 {{ __('asd.Видео галерея') }}			
                            </a>
                        </li>
                        <li class="submenu__item">
                            <a href="/arts" class="submenu__link">
                                 {{ __('asd.Арт галерея') }}			
                            </a>
                        </li>
                    </ul>
