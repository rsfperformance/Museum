    ...
    <div class="container">
        ...
        <div class="law-content">
            <div class="law__nav">
                <nav>
                    {{-- @for($i=1; $i<=3; $i++) --}}
                        ...
                        <a href="#">
                              {{ __('asd.Художественные фильмы') }}
                        </a>
                        <a href="#">
                              {{ __('asd.Документальные фильмы об Узбекистане') }}
                        </a>
                    {{-- @endfor --}}
                </nav>
            </div>
            <div class="law-tabs">
                ...
                {{--@for($i=1; $i<=3; $i++)--}}
                {{--<div class="law-tab" id="a">--}}
                    {{--<div class="videos-single__content">--}}
                        {{--@foreach(App\Video::where('one_id', $i)->get() as $data)--}}
                ...
                {{--@endfor--}}
                    <div class="law-tab" id="a">
                        <div class="videos-single__content">
                            @foreach(App\Video::where('one_id', 1)->get() as $data)
                                <div class="videos-carousel__item">
                                    <iframe src="{{ $data->video }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                </div>
                            @endforeach
                    ...
                    <div class="law-tab" id="a">
                        <div class="videos-single__content">
                            @foreach(App\Video::where('one_id', 3)->get() as $data)
                                <div class="videos-carousel__item">
                                    <iframe src="{{ $data->video }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                </div>
                            @endforeach
                    ...
                    <div class="law-tab" id="a">
                        <div class="videos-single__content">
                            @foreach(App\Video::where('one_id', 2)->get() as $data)
                                <div class="videos-carousel__item">
                                    <iframe src="{{ $data->video }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                </div>
                            @endforeach
